...
// بنقول للسيرفر: "خد بالك في ملف جديد اسمه chat فيه أوامر الشات بوت".
const chatbotRouter = require('./Route/ChatBotBackend.js');
...
// هنا بنحدد "العنوان"؛ أي حد عايز يكلم الشات بوت لازم يروح للعنوان ده: http://localhost:5000/api/chat/ask.
